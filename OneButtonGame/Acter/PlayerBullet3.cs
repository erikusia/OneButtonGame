...
{
    class PlayerBullet3:GameObject
    {
        ...
        Range range;
        int shotTime;
        public PlayerBullet3(Vector2 position, GameDevice gameDevice, IGameObjectMediator mediator, GameObjectManager gameObjectManager)
        ...
        public PlayerBullet3(PlayerBullet3 other)
