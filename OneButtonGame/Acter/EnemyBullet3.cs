...
namespace OneButtonGame.Acter
{
    class EnemyBullet3:GameObject
    {
        ...
        public EnemyBullet3(Vector2 position, GameDevice gameDevice, IGameObjectMediator mediator)
        ...
        public EnemyBullet3(EnemyBullet3 other)
